...
//Grammer Production Rules
  final public 
ArrayList<TableStruct> init() throws ParseException {ArrayList<TableStruct> tableList = new ArrayList<TableStruct>();
...
/* DROP TABLE */
  final public TableStruct drop() throws ParseException {Token T;
    Token queryType;
    TableStruct tableStruct;
...
{if ("" != null) return tableStruct;}
    throw new Error("Missing return statement in function");
  }

/* CREATE TABLE */
  final public TableStruct create() throws ParseException {Token T;
    Token queryType;
    TableStruct tableStruct;
