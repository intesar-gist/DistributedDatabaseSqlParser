...
//Grammer Production Rules
  final public Boolean init() throws ParseException {
...
/********* QL queries **********/
/********************************/
  final public QLQuery ProcessQLQuery() throws ParseException {
    QLQuery qlQuery;
    Token queryType;
...
/* select with and withuot joins */
  final public QLQuery selectWithJoins() throws ParseException {
    Token T;
...
/* COUNT TABLE */
  final public QLQuery countAllTable() throws ParseException {
    Token T;
    QLQuery qlQuery;
...
/* AGGREGATE FUNCTION WITH GROUP BY */
  final public QLQuery aggregateFuncWithGroupby() throws ParseException {
    Token T;
    QLQuery qlQuery;
    jj_consume_token(Q_ATTRIBUTE);
    jj_consume_token(O_COMMA);
...
/********* DML queries **********/
/********************************/
  final public DMLQuery ProcessDMLQuery() throws ParseException {
    DMLQuery dmlQuery;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case R_INSERT:
      dmlQuery = insert();
...
/* UPDATE TUPLE */
  final public DMLQuery updateTuple() throws ParseException {
    Token T;
    Token queryType;
    DMLQuery dmlQuery;
...
/* INSERT TABLE */
  final public DMLQuery insert() throws ParseException {
    Token T;
    Token queryType;
    DMLQuery dmlQuery;
...
/* DELETE TUPLE */
  final public DMLQuery deleteTuple() throws ParseException {
    Token T;
    Token queryType;
    DMLQuery dmlQuery;
...
/********* DDL queries **********/
/********************************/
  final public DDLQuery ProcessDDLQuery() throws ParseException {
    DDLQuery ddlQuery;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case R_CREATE:
      ddlQuery = create();
...
/* DROP TABLE */
  final public DDLQuery drop() throws ParseException {
    Token T;
    Token queryType;
    DDLQuery ddlQuery;
...
/* CREATE TABLE */
  final public DDLQuery create() throws ParseException {
    Token T;
    Token queryType;
    DDLQuery ddlQuery;
  ...
  final public HashMap ColumnsAndConstraints() throws ParseException {
  ...
  final public HashMap Columns() throws ParseException {
   Token TName;
   Token TType;
   HashMap<String,String> var = new HashMap<String, String>();
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x100,0x100,0x0,0x0,0x1800000,0x0,0x0,0x0,0x0,0x0,0x0,0x1800000,0x800,0x1800000,0x800,0x0,0x1800000,0x0,0x0,0x6f8000,0x1,0x0,0x0,0x0,0x1000000,0x800,0x0,0x800,0x0,0x400,0x0,0x0,0x1800000,0x800,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1e140000,0x1e140000,0x0,0x0,0x0,0x400000,0x8,0x0,0x10008,0x10008,0x400000,0x0,0x18100000,0x400000,0x8000,0x0,0x8000,0x0,0x400000,0x0,0x10008,0x10008,0x0,0x6,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x60080000,0x20080000,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x400,0x200,0x200,0x0,0x0,0x8000,0x0,0x0,0x0,0xc00,0x0,0x0,0x8000,0x0,0x8000,0x0,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,0x100,0x2,0x0,0x0,0x1000,0x0,0x1,0x0,0x20,0x0,0x9000,0x0,};
   }
